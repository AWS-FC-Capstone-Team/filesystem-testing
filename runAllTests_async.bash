...
do
  ...
  do
    echo "Number of threads: $i"
	  sysbench --num-threads="$i" --test=fileio --file-num=20 --file-io-mode=async --file-total-size=128G --file-test-mode=$j --time=30 run >> "LinuxHost_Outputs_Async/results_${i}_${j}.txt"
  done
